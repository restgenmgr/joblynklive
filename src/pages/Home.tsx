...
const Home = () => {
  return (
    <>
      ...
      {/* ===== NEW: GOLD/BROWN FRAMED KEYS (14 CARDS) ===== */}
      <div style={{
        padding: '80px 20px',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', justifyContent: 'center' }}>
            ...
            {[
              ...
              <Link
                key={idx}
                to={key.title === "Home" ? "/" : `/${key.title.toLowerCase().replace(/ /g, '')}`}
                style={{
                  background: 'white',
              ...
              >
                <div style={{ fontSize: '3rem', marginBottom: '15px' }}>{key.icon}</div>
                <h3 style={{ color: '#78350f', marginBottom: '10px' }}>{key.title}</h3>
                <p style={{ color: '#475569' }}>{key.desc}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* ===== ABOUT SECTION (your existing content) ===== */}
      <div style={{ padding: '80px 20px', background: '#ffffff' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <span style={{ background: '#2563eb', color: 'white', padding: '4px 16px', borderRadius: '40px', fontSize: '0.9rem', display: 'inline-block', marginBottom: '20px' }}>About Us</span>
      ...
      <div style={{ padding: '80px 20px', background: '#f8fafc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center' }}><div style={{ background: '#2563eb', width: '100px', height: '100px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '2rem', fontWeight: 'bold', margin: '0 auto 20px' }}>VK</div><h3 style={{ margin: '0 0 5px 0' }}>Vikram Khanna</h3><p style={{ color: '#64748b' }}>Founder</p></div>
            <div style={{ textAlign: 'center' }}><div style={{ background: '#2563eb', width: '100px', height: '100px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '2rem', fontWeight: 'bold', margin: '0 auto 20px' }}>NP</div><h3 style={{ margin: '0 0 5px 0' }}>Neha Patel</h3><p style={{ color: '#64748b' }}>Head of Operations</p></div>
            <div style={{ textAlign: 'center' }}><div style={{ background: '#2563eb', width: '100px', height: '100px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '2rem', fontWeight: 'bold', margin: '0 auto 20px' }}>AR</div><h3 style={{ margin: '0 0 5px 0' }}>Abdul Rahman</h3><p style={{ color: '#64748b' }}>Tech Lead</p></div>
          </div>
        </div>
      </div>
